<template>
  <section style="margin: 10px">
    ...
    >
      ...
      <el-table-column prop="name" align="center" label="审核状态" min-width="20%">
        <!-- <template #default="scope">{{ scope.row.zptypeVO.name }}</template> -->
      </el-table-column>
    ...
    >
      ...
      >
        ...
        <el-form-item label="作品名称" prop="name">
          <el-input maxlength="10" v-model="formData.name" style="width: 50%">
          
          </el-input>
        </el-form-item>
        <el-form-item label="作品介绍" prop="describe">
          <el-input v-model="formData.describe" style="width: 50%"></el-input>
        </el-form-item>
        <!-- <el-form-item label="区域" prop="qyid"  >
          <el-select
  ...
  data() {
    return {
      ...
      addrules: {
        ...
        ztid: [{ required: true, message: "请选择类型", trigger: "blur" }],
        fujian: [{ required: true, message: "请上传作品", trigger: "blur" }],
      },
      modifyrules: {
        name: [{ required: true, message: "请输入作品名称", trigger: "blur" }],
        ztid: [{ required: true, message: "请选择类型", trigger: "blur" }],
