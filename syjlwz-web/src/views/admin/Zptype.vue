        ...
        methods: {
            ...
            save() {
                if (this.formData.id != null) {
                    ...
                    if (valid) {
                    let url = base + "/zptype/update?id=" + this.formData.id;
            ...
            handleDelete(index, row) {
                ...
                let url = base + "/zptype/del?id=" + row.id;
            ...
            getDatas() {
                ...
                this.listLoading = true;
                let url = base + "/zptype/list?currentPage=" + this.page.currentPage;
                console.log(url);
