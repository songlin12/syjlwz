    ...
    <section style="margin: 10px">
        ...
        >
            <el-form
                    ...
                    label-width="100px"
            >
                                                    <el-form-item label="像素" prop="name">
    ...
    import request, { base } from "../../../utils/http";
        ...
        data() {
            return {
                ...
                addrules: {
                            name: [
                                                                    { required: true, message: "请输入像素", trigger: "blur" },
                                                    ],
                },
                modifyrules: {
                    name: [
        ...
        methods: {
            ...
            save() {
                if (this.formData.id != null) {
                    ...
                    if (valid) {
                    let url = base + "/zpxs/update?id=" + this.formData.id;
            ...
            handleDelete(index, row) {
                ...
                let url = base + "/zpxs/del?id=" + row.id;
            ...
            getDatas() {
                ...
                this.listLoading = true;
                let url = base + "/zpxs/list?currentPage=" + this.page.currentPage;
                console.log(url);
