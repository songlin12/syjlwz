        ...
        methods: {
            ...
            save() {
                if (this.formData.id != null) {
                    ...
                    if (valid) {
                    let url = base + "/zpqy/update?id=" + this.formData.id;
            ...
            handleDelete(index, row) {
                ...
                let url = base + "/zpqy/del?id=" + row.id;
            ...
            getDatas() {
                ...
                this.listLoading = true;
                let url = base + "/zpqy/list?currentPage=" + this.page.currentPage;
                console.log(url);
